...
class SignInPage extends StatefulWidget {
  final String title = 'Welcome to our flea market';
  @override
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            child:  Text('If you are not a member of our group please log in                 or, please click Register  ',
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                labelText: "So the password is:",
                hintText: "chose a password you want",
          ...
          Container(
            ...
            child: Text(
              _success == null
                  ? ''
                  : (_success
                  ? 'welcome to our market ' + _userEmail
                  : 'Sorry,please check your account name or password'),
